...
Shopify SEO QA 웹앱을 기준으로 제품 요구사항, 프롬프트 입력, Claude 검토, 에이전트 작업 설계, 디자인 기준, 참고 자산을 연결한 문서 묶음입니다.

## 구현된 사이트

- 목적: Shopify 사이트의 SEO 항목을 수집하고 통과/미통과, 평균 점수, 에러 상태를 내부 대시보드에서 확인합니다.
...
4. `/audits/[id]`에서 평균 점수, 통과/미통과, 페이지별 결과, 에러, 실행 기록을 확인합니다.
5. `/audits/[id]/pages/[pageId]`에서 특정 페이지의 추출 SEO 값과 항목별 판정을 확인합니다.
